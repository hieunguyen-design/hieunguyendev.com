...
A personal portfolio website showcasing professional experience, skills, and projects in web development and design.
...
The portfolio is divided into the following main sections:
...
_(Instructions on how to install, run, or deploy the project locally can be added here.)_

## Contact

For inquiries, please use the contact form available on the website or reach out via the email provided in the profile sidebar.
